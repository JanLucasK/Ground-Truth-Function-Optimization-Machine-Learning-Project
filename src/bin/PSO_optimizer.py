...
class PSO_optimizer():
    def __init__(self, model_path, input_bounds=None, bbob_function=None, num_particles=50) -> None:   
        self.model = self.load_model(model_path)
        self.input_bounds = input_bounds
        self.model.eval()
        self.bbob = bbob_function
    ...
    def optimize(self, initial_guess, niter=100, num_particles=50):
        ...
        fig = self.visualize_paths(self.bbob_path.values, self.model_path.values, result_bbob, result_nn, num_particles)

        return result_nn, result_bbob, fig
    
    def visualize_paths(self, path_bbob, path_model, result_bbob, result_model, num_particles):
        ...
        def animate(frame, num_particles):
            axes[0].clear()
            axes[1].clear()
